...
class Moderation(commands.Cog):
    ...
    @commands.command(help="returns info about current server")
    ...
    @commands.command(help="deletes x messages from the current channel")
    ...
    @commands.command(help="kicks an user from server")
    @commands.has_permissions(kick_members=True)
    async def kick(self, ctx, member: discord.Member, *, mod_reason="No reason provided."):
    ...
    @commands.command(help="bans an user from server")
    @commands.has_permissions(ban_members=True)
    async def ban(self, ctx, member: discord.Member, *, mod_reason="No reason provided."):
    ...
    @commands.command(help="unbans an user from server")
    @commands.guild_only()
    @commands.has_permissions(ban_members=True)
